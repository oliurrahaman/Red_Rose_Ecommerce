...
<header class="header-area header-style-1 header-height-2">
                            ...
                            @if(Session::get('customer_id'))
                                <li>
                                    <a class="language-dropdown-active" href="#"> <i
                                            ...
                                            class="fi-rs-angle-small-down"></i></a>
                                    <ul class="language-dropdown">
                                        <li><a href=""><i class="fi-rs-home"></i>Dashboard</a></li>
                                        <li><a href=""><i class="fi-rs-lock"></i>Logout</a>
                                        </li>
                                    </ul>
                                </li>
                            @else
                                <li><i class="fi-rs-user"></i><a href="">Log In / Sign Up</a>
                                </li>
                            @endif
    ...
    <div class="header-middle header-middle-ptb-1 d-none d-lg-block ">
        <div class="container">
            <div class="header-wrap sticky-bar">
                        ...
                        <div class="col-md-12">
                            <div class="">
                                <form action="{{url('/search')}}" method="GET" >
                                    <select class="input-select2" name="category">
                                    ...
                                    <input class="input" type="search" id="searchProduct" name="product" placeholder="Search Products..." value="{{request('product')}}">
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="main-categori-wrap d-none d-lg-block">
                        ...
                        <div class="categori-dropdown-wrap categori-dropdown-active-large">
                            <ul>
                                    ...
                                    <li class="">
                                        <a href=""><i class="evara-font-dress"></i></a>
                                                        ...
                                                        <ul class="d-lg-flex">
                                                            <li class="mega-menu-col col-lg-6">
                                                                <ul>
                                                                        ...
                                                                        <li><a class="dropdown-item nav-link nav_item" href=""></a></li>
                ...
                <div class="hotline d-none d-lg-block">
                    <p><i class="fi-rs-headset"></i><span>Hotline</span>  </p>
                </div>

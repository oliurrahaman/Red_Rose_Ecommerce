            ...
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        <a href="{{ route('product_offer.index') }}" class="btn btn-primary ms-auto">Manage Product Offer</a>
                    </div>
                    <div class="card-body">
{{--                        @include('admin.notify')--}}
                        <form action="{{ route('product_offer.update', $product_offer->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="discount_amount" value="{{  $product_offer->discount_amount }}">
